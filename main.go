...
func main() {
	...
	// Profile and Tokens
	public.POST("/profiles", handlers.CreateProfile(db))
	public.GET("/my_profile", handlers.GetMyProfile(db))
	public.GET("/my_projects", handlers.ListMyProjects(db))
	public.POST("/my_tokens", handlers.CreateToken(db))
	public.DELETE("/my_tokens/:token_id", handlers.DeleteToken(db))
	...
	public.POST("/projects/:project_id/instruments/:instrument_id/alert_configs", handlers.CreateInstrumentAlertConfigs(db))
	public.PUT("/projects/:project_id/instruments/:instrument_id/alert_configs/:alert_config_id", handlers.UpdateInstrumentAlertConfig(db))
	public.DELETE("/projects/:project_id/instruments/:instrument_id/alert_configs/:alert_config_id", handlers.DeleteInstrumentAlertConfig(db))
	...
	public.POST("/my_alerts/:alert_id/read", handlers.DoAlertRead(db))
	public.POST("/my_alerts/:alert_id/unread", handlers.DoAlertUnread(db))

	// AlertSubscriptions
	public.GET("/my_alert_subscriptions", handlers.ListMyAlertSubscriptions(db)) // Private because token required to determine user (i.e. who is "me")
	public.POST("/projects/:project_id/instruments/:instrument_id/alert_configs/:alert_config_id/subscribe", handlers.SubscribeProfileToAlerts(db))
	public.POST("/projects/:project_id/instruments/:instrument_id/alert_configs/:alert_config_id/unsubscribe", handlers.UnsubscribeProfileToAlerts(db))
	public.PUT("/alert_subscriptions/:alert_subscription_id", handlers.UpdateMyAlertSubscription(db))
	...
	public.POST("/projects", handlers.CreateProjectBulk(db), middleware.IsApplicationAdmin)
	public.PUT("/projects/:project_id", handlers.UpdateProject(db))
	public.DELETE("/projects/:project_id", handlers.DeleteFlagProject(db))

	// Project Membership
	// // list project memberships
	public.GET("/projects/:project_id/members", handlers.ListProjectMembers(db))
	// add role to a user
	public.POST("/projects/:project_id/members/:profile_id/roles/:role_id", handlers.AddProjectMemberRole(db))
	// remove role from a user
	public.DELETE("/projects/:project_id/members/:profile_id/roles/:role_id", handlers.RemoveProjectMemberRole(db))

	// Project Timeseries
	public.POST("/projects/:project_id/timeseries/:timeseries_id", handlers.CreateProjectTimeseries(db))
	public.DELETE("/projects/:project_id/timeseries/:timeseries_id", handlers.DeleteProjectTimeseries(db))
	...
	public.POST("/projects/:project_id/instruments", handlers.CreateInstruments(db))
	// TODO: Remove endpoint POST /instruments (no project context)
	public.POST("/instruments", handlers.CreateInstruments(db))
	public.PUT("/projects/:project_id/instruments/:instrument_id", handlers.UpdateInstrument(db))
	public.PUT("/projects/:project_id/instruments/:instrument_id/geometry", handlers.UpdateInstrumentGeometry(db))
	public.DELETE("/projects/:project_id/instruments/:instrument_id", handlers.DeleteFlagInstrument(db))
	...
	public.POST("/instrument_groups", handlers.CreateInstrumentGroup(db))
	public.PUT("/instrument_groups/:instrument_group_id", handlers.UpdateInstrumentGroup(db))
	public.DELETE("/instrument_groups/:instrument_group_id", handlers.DeleteFlagInstrumentGroup(db))
	// Add or Remove instrument from Instrument Group
	public.POST("/instrument_groups/:instrument_group_id/instruments", handlers.CreateInstrumentGroupInstruments(db))
	public.DELETE("/instrument_groups/:instrument_group_id/instruments/:instrument_id", handlers.DeleteInstrumentGroupInstruments(db))
	...
	public.POST("/projects/:project_id/instruments/:instrument_id/constants", handlers.CreateInstrumentConstants(db))
	public.DELETE("/projects/:project_id/instruments/:instrument_id/constants/:timeseries_id", handlers.DeleteInstrumentConstant(db))
	...
	public.POST("/instruments/notes", handlers.CreateInstrumentNote(db))
	public.PUT("/instruments/notes/:note_id", handlers.UpdateInstrumentNote(db))
	public.DELETE("/instruments/notes/:note_id", handlers.DeleteInstrumentNote(db))
	public.PUT("/instruments/:instrument_id/notes/:note_id", handlers.UpdateInstrumentNote(db))
	public.DELETE("/instruments/:instrument_id/notes/:note_id", handlers.DeleteInstrumentNote(db))
	...
	public.POST("/instruments/:instrument_id/status", handlers.CreateOrUpdateInstrumentStatus(db))
	public.DELETE("/instruments/:instrument_id/status/:status_id", handlers.DeleteInstrumentStatus(db))
	...
	public.POST("/timeseries", handlers.CreateTimeseries(db))
	public.PUT("/timeseries/:timeseries_id", handlers.UpdateTimeseries(db))
	public.DELETE("/timeseries/:timeseries_id", handlers.DeleteTimeseries(db))
	public.POST("/projects/:project_id/timeseries_measurements", handlers.CreateOrUpdateProjectTimeseriesMeasurements(db))
	...
	public.POST("/projects/:project_id/collection_groups", handlers.CreateCollectionGroup(db))
	public.PUT("/projects/:project_id/collection_groups/:collection_group_id", handlers.UpdateCollectionGroup(db))
	public.DELETE("/projects/:project_id/collection_groups/:collection_group_id", handlers.DeleteCollectionGroup(db))
	// // Collection Group; Add Timeseries to collection_group
	public.POST("/projects/:project_id/collection_groups/:collection_group_id/timeseries/:timeseries_id", handlers.AddTimeseriesToCollectionGroup(db))
	// // Collection Group; Remove Timeseries from collection_group
	public.DELETE("/projects/:project_id/collection_groups/:collection_group_id/timeseries/:timeseries_id", handlers.RemoveTimeseriesFromCollectionGroup(db))
	...
	public.PUT("/projects/:project_id/plot_configurations/:plot_configuration_id", handlers.UpdatePlotConfiguration(db))
	public.DELETE("/projects/:project_id/plot_configurations/:plot_configuration_id", handlers.DeletePlotConfiguration(db))
